...
{
    public class AdventOfCode2023OneModel
    {
        public AdventOfCode2023OneModel()
        {
            OneASampleData = @"1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet";
            OneAData = @"9eightone
...
5bszzkpcdxqkvkf7tgcone2";
        ...
        public string OneASampleData { get; set; }
        public string OneAData { get; set; }
        public string OneBSampleData { get; set; }
        public string OneBData { get; set; }
    }
}
